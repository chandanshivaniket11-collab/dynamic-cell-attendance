...
with st.sidebar:
    if LOGO_PATH:
        # 'use_container_width' makes it fill the sidebar width
...
# --- MAIN AREA: BIG LOGO & TITLE ---
# Changed ratio to [0.3, 0.7] to give the logo 30% of the screen
...
with col2:
    ...
    st.write(f"**Location:** Pune Center | **Focus:** {meeting_name}")

st.write("---")

# --- LIVE COUNTER & ATTENDANCE ---
attendance_data = []
